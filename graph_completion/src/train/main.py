...
# import numpy as np
# from tasks.graph_completion.chi.src.model_drum_torch import Learner \
#     as DrumTorchLearner
# from tasks.graph_completion.chi.src.model_drum_torch_withexist import Learner \
#     as DrumTorchLearnerWithExist
# from tasks.graph_completion.chi.src.model_drum_torch_nolstm import Learner \
#     as DrumTorchLearnerNoLSTM
# from tasks.graph_completion.chi.src.model_drum_logic_fn import Learner \
#     as DrumLogicFn
# from tasks.graph_completion.chi.src.model_drum_vecmodel import Learner \
#     as DrumVectorModel
from tasks.graph_completion.chi.src.model_lerp import Learner \
    as Lerp
from tasks.graph_completion.chi.src.model_transE import Learner as TransE

from tasks.graph_completion.chi.src.data import \
    Data, DataPlus, DataHeadwise
from tasks.graph_completion.chi.src.experiment import Experiment
...
def main():
    ...
    # model architecture
    parser.add_argument('--model', type=str, default="drum")
...
#     if option.model == "drum":
#         learner = DrumTorchLearner(option)
#     elif option.model == "drum_withexist":
#         learner = DrumTorchLearnerWithExist(option)
#     elif option.model == "drum_nolstm":
#         learner = DrumTorchLearnerNoLSTM(option)
#     elif option.model.startswith("drum_logic_fn"):
#         learner = DrumLogicFn(option)
#     elif option.model.startswith("drum_vecmodel"):
#         learner = DrumVectorModel(option)
    ...
    #         print(learner.lerp.interpret_rule(
    #             j, i, ["aunt", "brother", "daughter", "father", "husband", "mother",
    #                    "nephew", "niece", "sister", "son", "uncle", "wife"]))
    # for i in range(option.width):
    #     print(learner.lerp.interpret_lerp(
    #         -1, i, ["aunt", "brother", "daughter", "father", "husband", "mother",
    #                "nephew", "niece", "sister", "son", "uncle", "wife"]))
    # for i in range(2*option.num_relation):
    #     print(i)
    #     print_rules(i)
    # exit()
